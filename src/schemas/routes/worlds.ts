...
import {
    GetPlayersInWorldListOptionsSchema,
    GetPlayersInWorldOptionsSchema,
    GetWorldOptionsSchema,
    ListWorldsOptionsSchema,
    RandomWorldOptionsSchema,
    SearchWorldOptionsSchema,
} from "#schemas/services/worlds.js";
import {
    WorldListPlayersSchema,
    WorldPlayersSchema,
    WorldSchema,
    WorldStatsSchema,
...
export const WorldSortBySchema = Type.String({
	...
	description: `World sorting method to use for querying.
...
Throws HTTP 400 Bad Request if the format is not followed correctly.`,
	...
	examples: ["default", "+votes", "-visits", "recently_scraped"],
});
...
export const SchemaGetWorld = {
	...
	description:
		"Returns the world specified. You can get multiple worlds by using the [](/operations/listWorlds) endpoint.",
	tags: ["worlds"],
...
export const SchemaGetWorldList = {
	...
	description:
		"Returns a list of worlds. This can be narrowed down to specific entries via the querystrings. You can get a single world by using the [](/operations/getWorld) endpoint.",
	tags: ["worlds"],
...
export const SchemaSearchWorld = {
	...
	description:
		"Returns a list of worlds that is relevant to the search query. This searches the `normalized_name` field which makes this able to find worlds even if they have unicode variants of alphanumeric characters.",
	tags: ["worlds"],
...
export const SchemaGetWorldListStats = {
	...
	description:
		"Returns the stats of all worlds. You can get the stats of a single world by using the [](/operations/getWorldStats) endpoint.",
	tags: ["worlds"],
...
export const SchemaGetWorldStats = {
	...
	description:
		"Returns the stats of a single world. You can get the stats of all worlds by using the [](/operations/getWorldListStats)",
	tags: ["worlds"],
...
export const SchemaGetPlayersInWorldList = {
	...
	description:
		"Returns the players currently inside of each world. The list of worlds can be shrunk down via the querystrings. You can get the players currently inside a single world by using the [](/operations/getPlayersInWorld) endpoint.",
	tags: ["worlds"],
...
export const SchemaGetPlayersInWorld = {
	...
	description:
		"Returns the players currently inside of a single world. You can get the players currently inside of each world by using the [](/operations/getPlayersInWorldList) endpoint.",
	tags: ["worlds"],
